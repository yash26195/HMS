...
<form action="<%=request.getContextPath() %>/Admin?action=cribe&pid=<c:out value="${row.pid }"></c:out>" method="post"> 
  ...
  <table class="table" border="2" cellspacing="5" cellpadding="5" style="width:200 ; height:150">
    ...
    <tbody>
      ...
      <tr><th>Doctor</th>  <td><c:out value="${row.doctor}" > </c:out></td></tr>
        <tr><th>Precription</th><td><textarea rows=3 cols=15 name="prescription"></textarea></td></tr>
