...
<div id="addDoc" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
     ...
     <form role="form" action="<%=request.getContextPath() %>/Admin?action=add_patient" method="post">
   ...
   <select name="ward">
     ...
     <option >4</option>
      ...
      <div class="form-group">
   <label for="pn"> Description</label>
<textarea rows=3 cols=15 name="description"></textarea>
   </div>
    ...
    <tbody>
      ...
      <tr>
       <td><c:out value="${row.pname}" > </c:out></td>
        ...
        <td><c:out value="${row.pphno}" > </c:out></td>
       ...
       <td>
        ...
        <div class="btn-group">
          ...
          <a href="<%=request.getContextPath() %>/Admin?action=view_report&email=<c:out value="${row.pemail }"></c:out>">
